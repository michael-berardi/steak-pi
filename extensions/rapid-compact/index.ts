/**
 * Rapid Compact — vendored from github.com/sting8k/rapid-compact
 * (crates/rc-core engine required alongside: `rc` on PATH or ~/.local/bin/rc).
 * Upstream of record for this directory; keep syncs one-way (upstream → here).
 * Safety snapshots (below) preserve the Instant Snap guarantee this file
 * replaces: full pre-compaction state serialized to .steak-pi/snaps/.
 */
